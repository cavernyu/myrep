...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    ...
    if([segue.identifier isEqualToString:@"ShowSelectedCity"]){
        ...
        NSDictionary *dictData = [self.listData objectAtIndex:[[self.tableView indexPathForSelectedRow] row]];
        detailViewController.urlStr = [dictData objectForKey:@"url"];
        
        detailViewController.title = [dictData objectForKey:@"name"];
